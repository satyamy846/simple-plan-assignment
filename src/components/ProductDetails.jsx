...
export default function ProductDetails() {
    return (
        <>
            <div className="p-5 md:p-10 lg:p-24 flex flex-col" id="products">
                <div className="heading flex justify-between items-center py-3">
                    <div className="heading-left flex gap-3 items-baseline flex-wrap">
                    ...
                    <div className="heading-right flex gap-4 items-center flex-wrap justify-end">
                                    ...
                                    <div className='relative'>
                                        ...
                                        <div className='absolute top-2 right-2 bg-white p-2'>
                                            <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11 15L5.99942 11.9565L1 15V1.6087C1 1.44726 1.06585 1.29244 1.18306 1.17828C1.30027 1.06413 1.45924 1 1.625 1H10.375C10.5408 1 10.6997 1.06413 10.8169 1.17828C10.9342 1.29244 11 1.44726 11 1.6087V15Z" stroke="#1B1B1B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
